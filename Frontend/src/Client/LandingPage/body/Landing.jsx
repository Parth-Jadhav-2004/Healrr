...
function Landing() {
  const commonChallengesstr =
    "These challenges are part of life's journey, but you don't have to face them alone. Join us we will help";
  return (
    <>
      <div className="landingPage-body-wrapper">
        <section className="grid-container" id="home">
          <div className="image-container">
            ...
            <div className="text-overlay">
              <h1>HealR</h1>
              <p>
                You are not alone. You are seen. I am with you. You are not
                alone.
              </p>
        ...
        <section className="landingPage-body-section commonChallenges">
          <div className="commonChallenges-title">
            ...
            <div>
              <p>{commonChallengesstr}</p>
            </div>
          </div>
          <div className="commonChallenges-gridContainer">
            <div className="gridItem-flexContainer">
                <a href="https://www.hopkinsmedicine.org/health/conditions-and-diseases/depression">
              <img src={Depression} alt=" comman challage depression" />
              </a>
              <h3 className="flexItem-title">Depression</h3>
              <p className="flexItem-description">
                a heavy fog that blankets the mind, sapping joy and energy
              </p>
            </div>
            <div className="gridItem-flexContainer">
              <a
                href="https://www.hopkinsmedicine.org/health/conditions-and-diseases/anxiety-disorders"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={Anxiety} alt="common challenge Anxiety" />
              </a>
              <h3 className="flexItem-title">Anxiety</h3>
              <p className="flexItem-description">
                a relentless companion, causing a perpetual state of worry and
                unease
              </p>
            </div>
            ...
            <div className="gridItem-flexContainer">
              <a
                href="https://www.hopkinsmedicine.org/health/conditions-and-diseases/manic-depression--bipolar-disorder"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <p className="flexItem-description">
                a rollercoaster of highs and lows, disrupting the equilibrium of
                daily life.
              </p>
            </div>
            <div className="gridItem-flexContainer">
              <a
                href="https://publichealth.jhu.edu/2020/how-to-prevent-social-isolation-from-making-loneliness-worse"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <p className="flexItem-description">
                {" "}
                haunting sensation that isolates one from the world, leaving an
                ache for connection
              </p>
            </div>
            <div className="gridItem-flexContainer">
                <a href="https://www.hopkinsmedicine.org/health/conditions-and-diseases/posttraumatic-stress-disorder-ptsd">
              <img
                src={Ptsd}
                alt=" comman challage Post-traumatic stress disorder"
              /></a>
              <h3 className="flexItem-title">Post-traumatic stress disorder</h3>
              <p className="flexItem-description">
                PTSD, a battle scar from past trauma, triggering overwhelming
                emotions and flashbacks.
              </p>
            </div>
            <div className="gridItem-flexContainer">
                <a href="https://www.hopkinsmedicine.org/health/conditions-and-diseases/adhdadd">
              <img src={ADHD} alt=" comman challage ADHD" /></a>
              <h3 className="flexItem-title">ADHD</h3>
              <p className="flexItem-description">
                where the mind races like a loose steering wheel, and focus
                slips like a stuck gas pedal.
              </p>
            </div>
          </div>
        </section>
        <section className="landingPage-body-section Services" id="services">
          ...
          <div className="Services-gridContainer">
            <div className="Services-gridContainer-item1">
              ...
              <p>Access to specialized therapist sessions.</p>
              <img
            ...
            <div className="Services-gridContainer-item2 containerTwo">
              <div className="Services-gridContainer-containerTwo-item1">
                <h2>Anonymity Q&A</h2>
                <p>Ask questions anonymously to therapists.</p>
                <img
                  className="Servicesimg"
                  src={QandA}
              ...
              <div className="Services-gridContainer-containerTwo-item2">
                ...
                <p>Access books,music and much more.</p>
                <img
                  className="Servicesimg"
                  src={ResourceLibrary}
            ...
            <div className="Services-gridContainer-item3">
              ...
              <p>Share experiences and connect</p>
